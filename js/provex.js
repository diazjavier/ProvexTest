window.addEventListener('load', function() {
  ...
  window.addEventListener("scroll", function(){
    ...
    let buscador = document.getElementById("panelBuscador");
    // let sidebar = document.getElementById("sidebar");
    let altura = getTop(buscador);

    if(walt >= 95){
      // sidebar.style = "top: 120px; position: fixed; z-index: 1000;";
      buscador.style = "width:100%; padding: 1%; top: 60px; position: fixed; z-index: 1000; background-color: #e1e1e1;";

    }else{
      // sidebar.style = "top: auto; position: relative;";
      buscador.style = "top: auto;";
    }
  });
